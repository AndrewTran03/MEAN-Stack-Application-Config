...
// import { mongoDbRef } from "../background_app";
...
//     try {
//         const currItems = await mongoDbRef.collection<Human>(humanMongoCollectionName).find().toArray();
...
//     try {
//         const humanInsertResult = await mongoDbRef.collection<Human>(humanMongoCollectionName).insertOne(humanToInsert);
...
//     try {
//         const humanUpdateResult = await mongoDbRef
//             .collection<Human>(humanMongoCollectionName)
//             .findOneAndUpdate({ _id: new ObjectId(humanToUpdateId) }, humanToUpdateFields, {
...
//     try {
//         const humanDeleteResult = await mongoDbRef
//             .collection<Human>(humanMongoCollectionName)
//             .findOneAndDelete({ _id: new ObjectId(humanToDeleteId) });
